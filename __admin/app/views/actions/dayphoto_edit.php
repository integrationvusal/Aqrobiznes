...
$(document).ready(function() {
	...
	var ms = $('#magicsuggest').magicSuggest({
        ...
        name: 'tags',
        placeholder: '<?=CMS::t('dayphoto_keywords_select')?>'
    });
...
<section class="content">
	...
	<div class="box" style="border-top: none;">
		<!-- <div class="box-header with-border">
			<h3 class="box-title"><?=CMS::t('menu_item_dayphoto_edit');?></h3>
		</div> -->
		<!-- /.box-header -->
						...
						<div id="desc-tab-<?=$lng['language_dir']?>" class="tab-pane">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label><?=CMS::t('dayphoto_title');?> <?=(($lng['language_dir']==CMS::$default_site_lang)? '*': '');?></label>
									...
									<div class="form-group">
										<label><?=CMS::t('dayphoto_full');?> <?=(($lng['language_dir']==CMS::$default_site_lang)? '*': '');?></label>
...
// ]]>
						...
						<div class="tab-pane active" id="common-tab">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="id-number"><?=CMS::t('dayphoto_id_num')?>: &nbsp; <?=$news['id']?></label>
									</div>
									<div class="form-group">
										<label><a href="https://google.com/?q=SEF+friendly+urls" title="" target="_blank"><?=CMS::t('dayphoto_sef');?> <i class="fa fa-external-link" aria-hidden="true" style="font-size: inherit;"></i></a></label>

										<input type="text" name="sef" value="<?=utils::safePostValue('sef', $news['sef'], 1);?>" class="form-control" />
										<!-- <p class="form-input-tip"><?=CMS::t('dayphoto_sef_descr');?></p> -->
									</div>
									...
									<div class="form-group">
										...
										<div class="image-preview">
											...
											<div class="image-preview-info">
												...
												?>
												<?=CMS::t('dayphoto_image_original_size');?>: <?=$orgSize['value'];?> <?=$orgSize['measure'];?><br />
												<?=CMS::t('dayphoto_image_thumbnail_size');?>: <?=$tmbSize['value'];?> <?=$tmbSize['measure'];?><br />
												<?=CMS::t('dayphoto_image_original_upload_datetime');?>: <?=($imgModTimestamp? date('d.m.Y H:i:s', $imgModTimestamp): '-');?><br />
												<br />
												<br />
												<?php if ($preview_exists) { ?>
												<a href="<?=$previewUrl;?>" target="_blank"><img src="<?=IMAGE_DIR;?>eye_white.png" alt="" style="height: 16px;" /> <?=CMS::t('dayphoto_image_original_view');?> <img src="<?=IMAGE_DIR;?>outer_link_white.png" alt="" /></a>
												<?php } ?>
												<?php if (CMS::hasAccessTo('dayphoto/ajax_delete_image', 'write')) { ?>
												<a href="?controller=dayphoto&amp;action=ajax_delete_image" id="aDelImg"><img src="<?=IMAGE_DIR;?>drop_white.png" alt="" style="height: 16px;" /> <?=CMS::t('delete');?></a>
												</p>
												<?php } ?>
											</div>
										</div>
										...
										<p class="form-info-tip"><?=CMS::t('dayphoto_image_descr', [
									...
									<div class="form-group">
										<label><?=CMS::t('dayphoto_add_datetime');?></label>
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group">
													<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
													<input type="text" name="add_date" value="<?=utils::safePostValue('add_date', utils::formatMySQLDate('d.m.Y', $news['add_datetime']), 1);?>" placeholder="<?=CMS::t('dayphoto_publish_date_placeholder');?>" class="form-control datepicker" />
												</div>
...
// ]]>
											...
											<div class="col-xs-6">
												<select name="add_hour" class="form-control" style="display: inline-block; width: 45%;">
													<option value=""><?=CMS::t('dayphoto_publish_hour_placeholder');?></option>
													<?php
												...
												<select name="add_minutes" class="form-control" style="display: inline-block; width: 45%;">
													<option value=""><?=CMS::t('dayphoto_publish_minutes_placeholder');?></option>
													<?php
									...
									<div class="form-group">
										<label><?=CMS::t('dayphoto_publish_datetime');?></label>

										<div class="row">
											<div class="col-xs-6">
												<div class="input-group">
													<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
													<input type="text" name="publish_date" value="<?=utils::safePostValue('publish_date', utils::formatMySQLDate('d.m.Y', $news['publish_datetime']), 1);?>" placeholder="<?=CMS::t('dayphoto_publish_date_placeholder');?>" class="form-control datepicker" />
												</div>
