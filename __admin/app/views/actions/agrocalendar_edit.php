...
<script>
	...
	<section class="content-header">
		<h1>
			<?=CMS::t('menu_item_agrocalendar_edit');?>
						...
						<div class="col-md-12">
						    <div class="form-group">
								...
								<div class="form-group">
										...
										<textarea name="full" rows="4" cols="32" class="form-input-std" id="wysiwyg_full"><?=(isset($_POST['full'])? $_POST['full']: $data['full']);?></textarea>
