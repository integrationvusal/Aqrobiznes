...
<section class="content-header">
	<h1>
		<?=CMS::t('menu_item_agrocalendar_add');?>
...
<section class="content">
	...
	<div class="box">
		<!-- <div class="box-header with-border">
			<h3 class="box-title"><?=CMS::t('menu_item_agrocalendar_add');?></h3>
		</div> -->
		<!-- /.box-header -->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							<label><?=CMS::t('agrocalendar_title');?> *</label>
							<input type="text" name="title" class="form-control" autocomplete="off" />
						</div>
						
						<div class="form-group">
							<label><?=CMS::t('agrocalendar_content');?> *</label>

							<textarea name="full" rows="4" cols="32" class="form-input-std" id="wysiwyg_full"></textarea>
							<script type="text/javascript">
// <![CDATA[
CKEDITOR.replace('wysiwyg_full', {
uiColor: '#f9f9f9',
language: 'az',
...
// ]]>
						...
						<div class="form-group">
							<input type="checkbox" name="is_published" value="1"<?=((isset($_POST['is_published']) && empty($_POST['is_published']))? '': ' checked="checked"');?> id="triggeragrocalendarStatus" /><label for="triggeragrocalendarStatus" style="display: inline; font-weight: normal;"> <?=CMS::t('publish');?></label>
						</div>
					</div>
				</div>
			</div>
