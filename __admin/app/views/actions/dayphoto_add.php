...
<section class="content">
    ...
    <div class="box" style="border-top: none; ">
        <!-- <div class="box-header with-border">
			<h3 class="box-title"><?= CMS::t('menu_item_dayphoto_add'); ?></h3>
		</div> -->
        <!-- /.box-header -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><a href="https://google.com/?q=SEF+friendly+urls" title=""
                                                  target="_blank"><?= CMS::t('dayphoto_sef'); ?> <i
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="add_date"
                                                           ...
                                                           placeholder="<?= CMS::t('dayphoto_publish_date_placeholder'); ?>"
                                            ...
                                            <div class="col-xs-6">
                                                <select name="add_hour" class="form-control"
                                                    ...
                                                    <option value=""><?= CMS::t('dayphoto_add_hour_placeholder'); ?></option>
                                                    <?php
                                                ...
                                                <select name="add_minutes" class="form-control"
                                                        style="display: inline-block; width: 45%;">
                                                    <option value=""><?= CMS::t('dayphoto_add_minutes_placeholder'); ?></option>
                                                    <?php
