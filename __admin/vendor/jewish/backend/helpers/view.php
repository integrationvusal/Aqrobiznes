	...
	public static $menu = [
		...
		[
			...
			'subs' => [
				...
				'dayphoto/list' => [
					'selected' => ['dayphoto/list', 'dayphoto/edit', 'dayphoto/add']
				],
				...
				'questions/list' => [
					'selected' => ['questions/list', 'questions/edit']
				],
