    ...
    <section class="single padding50">
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="full active"><a href="#interview" aria-controls="interview" role="tab" data-toggle="tab">@lang('custom.blocks.clauses_list')</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="author">
                    <div class="author-block">                      
                        ...
                        <div class="row">
    						<div class="col-xs-12">
    							<button class="load-more" data-route="clauses">Daha çox <i class="fa fa-spinner fa-spin"></i></button>
    						</div>
    					</div>
                    </div>
                </div>
